...
<body>
  ...
  <div class="row">
    <div class="col-md-12 bg-dark"  style="height: 70px">
      <ul>
       <!--  <li style="float: left;padding: 10px;"><p class="text-light lead" id="demo"></p> </li> -->
        <li style="float: left;padding-top: 20px; padding-left: 20px;"><a style="color: white"  href="https://dinshikkha.com/about/">Home</a> </li>
      </ul>
    </div>
  </div>
</div>
        ...
        <div class="row">
            <div class="col-md-6">
              <nav class="navbar navbar-light  justify-content-between">
                <a class="navbar-brand md-text-right"> <img style="border-radius: 100%; margin-top: -15px;" height="70px"  width="100px;"  src="image/Logo design 1.jpg"></a>
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>নাম </b></td><td style="vertical-align:middle"><b>মোট প্রশ্ন </b></td><td style="vertical-align:middle"><b>সঠিক উত্তরের জন্য </b></td><td style="vertical-align:middle"><b>ভুল উত্তরের জন্য</b></td><td style="vertical-align:middle"><b>মোট নাম্বার</b></td><td style="vertical-align:middle"><b>Time limit</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    $c = 1;
  ...
  <td style="vertical-align:middle"><b><a href="account.php?q=result&eid=' . $eid . '" class="btn" style="margin:0px;background:darkred;color:white">&nbsp;<span class="title1"><b>View Result</b></span></a></b></td></tr>';
    ...
    $c = 0;
 echo '</table></div> <div class="col-md-12" style="background-color:white;">
            
                <h3 class="text-center">::<b> প্রততিযোগিতার নিয়মাবলিঃ </b> ::</h3><br>
            <p class="lead" >
                ১। দ্বীন শিক্ষা. কম এর ওয়েবসাইট এর গিয়ে নিজের সঠিক তথ্যদিয়ে রেজিষ্ট্রেশন সম্পূর্ণ করতে হবে।<br />
                ২। কেউ যদি ভূল তথ্য দিয়ে রেজিষ্ট্রেশন করে ফলে সে পুরষ্কার থেকে বঞ্চিত হবে। <br />
                ৩। অবশ্যই সবাইকে দ্বীন শিক্ষা. কম এর ওয়েবসাইট  এর মাধ্যমে প্রতিযোগিতায় অংশ গ্রহণ করতে হবে। <br />
                ৪। একজন ব্যবহারকারী একবার প্রতিযোগিতায় অংশ গ্রহণ করতে পারবে।  <br />
                ৫। নির্দিষ্ট সময়ে রেজিষ্ট্রেশন করতে হবে। <br />
                ৬। সবাইকে আমাদের ফেসবুক পেজ, ফেসবুক গ্রুপ এ জয়েন করতে হবে এবং দ্বীন শিক্ষা.কম এর ইউটিউব চ্যানেল সাবস্ক্রাইব করতে হবে। ( দ্বীনের জ্ঞান অর্জন এবং প্রচারের স্বার্থে) <br />
                 ৭) প্রশ্নের উত্তর চারটি থেকে যেকোন একটি পছন্দ করতে হবে। <br />
                ৮) মোট প্রশ্ন থাকবে 4০টি।  ১5 মিনিটের মধ্য উত্তর দিতে হবে। 15 মিনিট হয়ে গেলে আপনাকে আপনার রেজাল্ট দেখানো হবে।(আপনি এই সময়ের মধ্যে শেষ না করতে পারলেও তা অটোমেটিক শেষ হয়ে যাবে) <br />
                ৮) একই ব্যক্তির একাধিক উত্তরপত্র গ্রহনযোগ্য নয়।  <br />
                ৯) প্রতিযোগিতার ক্ষেত্রে কোন অসৎ  উপায় অবলম্বন করা যাবেনা। <br />
                ১০) নিজের পশ্নের উত্তর নিজেই দিতে হবে। 
            </p>
...
var countdownTimer = setInterval(\'secondPassed()\', 1000);
            ...
            while ($row = mysqli_fetch_array($q)) {
                ...
                $qid = $row['qid'];
                echo '<b><pre style="background-color:white"><div style="font-size:10px;font-weight:bold;font-family:calibri;margin:10px">' . $sn . ' : ' . $qns . '</div></pre></b>';
            }
...
<tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Score</b></td></tr>';
    ...
    if($total >= $showfrom){
        ...
        while ($row = mysqli_fetch_array($q)) {
            ...
            $c++;
            echo '<tr><td style="color:#99cc32"><b>' . $c . '</b></td><td style="vertical-align:middle">' . $name . '<td style="vertical-align:middle">' . $username . '</td><td style="vertical-align:middle">' . $s . '</td><td style="vertical-align:middle">';
        }
    }
    else{
    }
...
<a href="https://dinshikkha.com/" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Organized by dinshikkha.com</a>
</div>
